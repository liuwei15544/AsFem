...
// reader for boundary block information

#include "InputSystem/InputSystem.h"

bool InputSystem::ReadBoundaryBlock(vector<BCBlockInfo> &bcBlockList)
{
    // format:
    // [bcs]
    //   [left]
    ...
    bcBlockList.clear();
    BCBlockInfo bcBlockInfo;

    int linenum=0;
    string str,line,line0="bcs";
    int blockstartlinenum;
    vector<double> numbers;
    bool ReadKernelBlockSuccess=false;

    bool HasDof=false,HasSideName=false,HasValue=false,HasType=false;
